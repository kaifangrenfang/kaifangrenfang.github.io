...
- [1 About](#about)  
  - [1.1 Authors](#about/authors)  
- [2 Overview](#overview)  
  - [2.1 Principles](#overview/principles)  
  - [2.2 Physically Based Rendering](#overview/physicallybasedrendering)  
- [3 Notation](#notation)  
- [4 Material System](#materialsystem)  
  - [4.1 Standard Model](#materialsystem/standardmodel)  
  - [4.2 Dielectrics and Conductors](#materialsystem/dielectricsandconductors)  
  - [4.3 Energy Conservation](#materialsystem/energyconservation)  
  - [4.4 Specular BRDF](#materialsystem/specularbrdf)  
    - [4.4.1 Normal Distribution Function (Specular D)](#materialsystem/specularbrdf/normaldistributionfunction-speculard)  
    - [4.4.2 Geometric Shadowing (Specular G)](#materialsystem/specularbrdf/geometricshadowing-specularg)  
    - [4.4.3 Fresnel (Specular F)](#materialsystem/specularbrdf/fresnel-specularf)  
  - [4.5 Diffuse BRDF](#materialsystem/diffusebrdf)  
  - [4.6 Standard Model Summary](#materialsystem/standardmodelsummary)  
  - [4.7 Improving the BRDFs](#materialsystem/improvingthebrdfs)  
    - [4.7.1 Energy Gain in Diffuse Reflectance](#materialsystem/improvingthebrdfs/energygainindiffusereflectance)  
    - [4.7.2 Energy Loss in Specular Reflectance](#materialsystem/improvingthebrdfs/energylossinspecularreflectance)  
  - [4.8 Parameterization](#materialsystem/parameterization)  
    - [4.8.1 Standard Parameters](#materialsystem/parameterization/standardparameters)  
    - [4.8.2 Types and Ranges](#materialsystem/parameterization/typesandranges)  
    - [4.8.3 Remapping](#materialsystem/parameterization/remapping)  
    - [4.8.4 Blending and Layering](#materialsystem/parameterization/blendingandlayering)  
    - [4.8.5 Crafting Physically Based Materials](#materialsystem/parameterization/craftingphysicallybasedmaterials)  
  - [4.9 Clear Coat Model](#materialsystem/clearcoatmodel)  
    - [4.9.1 Clear Coat Specular BRDF](#materialsystem/clearcoatmodel/clearcoatspecularbrdf)  
    - [4.9.2 Integration in the Surface Response](#materialsystem/clearcoatmodel/integrationinthesurfaceresponse)  
    - [4.9.3 Clear Coat Parameterization](#materialsystem/clearcoatmodel/clearcoatparameterization)  
    - [4.9.4 Base Layer Modification](#materialsystem/clearcoatmodel/baselayermodification)  
  - [4.10 Anisotropic Model](#materialsystem/anisotropicmodel)  
    - [4.10.1 Anisotropic Specular BRDF](#materialsystem/anisotropicmodel/anisotropicspecularbrdf)  
    - [4.10.2 Anisotropic Parameterization](#materialsystem/anisotropicmodel/anisotropicparameterization)  
  - [4.11 Subsurface Model](#materialsystem/subsurfacemodel)  
    - [4.11.1 Subsurface Specular BRDF](#materialsystem/subsurfacemodel/subsurfacespecularbrdf)  
    - [4.11.2 Subsurface Parameterization](#materialsystem/subsurfacemodel/subsurfaceparameterization)  
  - [4.12 Cloth Model](#materialsystem/clothmodel)  
    - [4.12.1 Cloth Specular BRDF](#materialsystem/clothmodel/clothspecularbrdf)  
    - [4.12.2 Cloth Diffuse BRDF](#materialsystem/clothmodel/clothdiffusebrdf)  
    - [4.12.3 Cloth Parameterization](#materialsystem/clothmodel/clothparameterization)  
- [5 Lighting](#lighting)  
  - [5.1 Units](#lighting/units)  
    - [5.1.1 Light Units Validation](#lighting/units/lightunitsvalidation)  
  - [5.2 Direct Lighting](#lighting/directlighting)  
    - [5.2.1 Directional Lights](#lighting/directlighting/directionallights)  
    - [5.2.2 Punctual Lights](#lighting/directlighting/punctuallights)  
    - [5.2.3 Photometric Lights](#lighting/directlighting/photometriclights)  
    - [5.2.4 Area Lights](#lighting/directlighting/arealights)  
    - [5.2.5 Lights Parameterization](#lighting/directlighting/lightsparameterization)  
    - [5.2.6 Pre-Exposed Lights](#lighting/directlighting/pre-exposedlights)  
  - [5.3 Image-Based Lights](#lighting/imagebasedlights)  
    - [5.3.1 IBL Types](#lighting/imagebasedlights/ibltypes)  
    - [5.3.2 IBL Unit](#lighting/imagebasedlights/iblunit)  
    - [5.3.3 Processing Light Probes](#lighting/imagebasedlights/processinglightprobes)  
  - [5.4 Static Lighting](#lighting/staticlighting)  
  - [5.5 Transparency and Translucency Lighting](#lighting/transparencyandtranslucencylighting)  
    - [5.5.1 Transparency](#lighting/transparencyandtranslucencylighting/transparency)  
    - [5.5.2 Translucency](#lighting/transparencyandtranslucencylighting/translucency)  
  - [5.6 Occlusion](#lighting/occlusion)  
  - [5.7 Normal Mapping](#lighting/normalmapping)  
- [6 Volumetric Effects](#volumetriceffects)  
- [7 Anti-Aliasing](#anti-aliasing)  
- [8 Imaging Pipeline](#imagingpipeline)  
  - [8.1 Physically Based Camera](#imagingpipeline/physicallybasedcamera)  
  - [8.2 Optics Post-Processing](#imagingpipeline/opticspost-processing)  
  - [8.3 Filmic Post-Processing](#imagingpipeline/filmicpost-processing)  
- [9 Annex](#annex)  
  - [9.1 Specular Color](#annex/specularcolor)  
  - [9.2 Importance Sampling for the IBL](#annex/importancesamplingfortheibl)  
...
Real-time rendering is an active area of research and there is a large number of equations, algorithms and implementation to choose from for every single feature that needs to be implemented (the book _Rendering real-time shadows_, for instance, is a 400 pages summary of dozens of shadows rendering techniques). As such, we must first define our goals (or principles, to follow Brent Burley's seminal paper Physically-based shading at Disney [Burley12](#citation-burley12)) before we can make informed decisions.
...
The equations found throughout this document use the symbols described in [table 1](#table_symbols).
...
| $ \chi^+(a) $                | Heaviside function (1 if $ a > 0 $, 0 otherwise)           |
| $ n_{ior} $                 | Index of refraction (IOR) of an interface                  |
| $ \left< n \cdot l \right> $ | Dot product clamped to $[0..1]$                            |
...
The relationship between a surface, the surface normal, incident light and these terms is shown in [figure 1](#figure_frfd) (we ignore subsurface scattering for now):

![diagram_fr_fd.png](/images/diagram_fr_fd.png)
...
A microfacet BRDF is a good physically plausible BRDF for that purpose. Such BRDF states that surfaces are not smooth at a micro level, but made of a large number of randomly aligned planar surface fragments, called microfacets. [Figure 2](#figure_microfacetvsflat) shows the difference between a flat interface and an irregular interface at a micro level:

![diagram_microfacet.png](/images/diagram_microfacet.png)

> **Figure 2:** Irregular interface as modeled by a microfacet model (left) and flat interface (right)

Only the microfacets whose normal is oriented halfway between the light direction and the view direction will reflect visible light, as shown in [figure 3](#figure_microfacets).

![diagram_macrosurface.png](/images/diagram_macrosurface.png)

> **Figure 3:** Microfacets

However, not all microfacets with a properly oriented normal will contribute reflected light as the BRDF takes into account masking and shadowing. This is illustrated in [figure 4](#figure_microfacetshadowing).

![diagram_shadowing_masking.png](/images/diagram_shadowing_masking.png)
...
[Figure 5](#figure_roughness) shows surfaces of different roughness and how light interacts with them.

![diagram_roughness.png](/images/diagram_roughness.png)

> **Figure 5:** Varying roughness (from left to right, rough to smooth) and the resulting BRDF specular component lobe

About roughness

The roughness parameter as set by the user is called `perceptualRoughness` in the shader snippets throughout this document. The variable called `roughness` is the `perceptualRoughness` with a remapping explained in section [4.8](#toc4.8).
...
The term $D$ models the distribution of the microfacets (this term is also referred to as the NDF or Normal Distribution Function). This term plays a primordial role in the appearance of surfaces as shown in [figure 5](#figure_roughness).
...
![diagram_micro_vs_macro.png](/images/diagram_micro_vs_macro.png)
...
We saw earlier that when incident light hits a surface governed by a BRDF, the light is reflected as two separate components: the diffuse reflectance and the specular reflectance. The modelization of this behavior is straightforward as shown in [figure 7](#figure_bsdfbrdf).

![diagram_fr_fd.png](/images/diagram_fr_fd.png)

> **Figure 7:** Modelization of the BRDF part of a BSDF

This modelization is a simplification of how the light actually interacts with the surface. In reality, part of the incident light will penetrate the surface, scatter inside, and exit the surface again as diffuse reflectance. This phenomenon is illustrated in [figure 8](#figure_diffusescattering).

![diagram_scattering.png](/images/diagram_scattering.png)
...
To properly modelize the BRDF we must therefore distinguish between dielectrics and conductors (scattering not shown for clarity), as shown in [figure 9](#figure_dielectricconductor).

![diagram_brdf_dielectric_conductor.png](/images/diagram_brdf_dielectric_conductor.png)
...
Given our real-time constraints, we must use an approximation for the three terms $D$, $G$ and $F$. [Karis13a](#citation-karis13a) has compiled a great list of formulations for these three terms that can be used with the Cook-Torrance specular BRDF. The sections that follow describe the equations we picked for these terms.

### Normal distribution function (specular D)

[Burley12](#citation-burley12) observed that long-tailed normal distribution functions (NDF) are a good fit for real-world surfaces. The GGX distribution described in [Walter07](#citation-walter07) is a distribution with long-tailed falloff and short peak in the highlights, with a simple formulation suitable for real-time implementations. It is also a popular model, equivalent to the Trowbridge-Reitz distribution, in modern physically based renderers.

$$
 D_{GGX}(h,\alpha) = \frac{\alpha^2}{\pi ( (n \cdot h)^2 (\alpha^2 - 1) + 1)^2}
$$

The GLSL implementation of the NDF, shown in [listing 1](#listing_speculard), is simple and efficient.
...
We can improve this implementation by using half precision floats. This optimization requires changes to the original equation as there are two problems when computing $1 - (n \cdot h)^2$ in half-floats. First, this computation suffers from floating point cancellation when $(n \cdot h)^2$ is close to 1 (highlights). Secondly $n \cdot h$ does not have enough precision around 1.
...
Since both $n$ and $h$ are unit vectors, $|n \times h|^2 = 1 - (n \cdot h)^2$. This allows us to compute $1 - (n \cdot h)^2$ directly with half precision floats by using a simple cross product. [Listing 2](#listing_speculardfp16) shows the final optimized implementation.
...
Eric Heitz showed in [Heitz14](#citation-heitz14) that the Smith geometric shadowing function is the correct and exact $G$ term to use. The Smith formulation is the following:
...
The GLSL implementation of the visibility term, shown in [listing 3](#listing_specularv), is a bit more expensive than we would like since it requires two `sqrt` operations.
...
This approximation is mathematically wrong but saves two square root operations and is good enough for real-time mobile applications, as shown in [listing 4](#listing_approximatedspecularv).
...
[Hammon17](#citation-hammon17) proposes the same approximation based on the same observation that the square root can be removed. It does so by rewriting the expressions as _lerps_:
...
The Fresnel effect plays an important role in the appearance of physically based materials. This effect models the fact that the amount of light the viewer sees reflected from a surface depends on the viewing angle. Large bodies of water are a perfect way to experience this phenomenon, as shown in [figure 10](#figure_fresnellake). When looking at the water straight down (at normal incidence) you can see through the water. However, when looking further out in the distance (at grazing angle, where perceived light rays are getting parallel to the surface), you will see the specular reflections on the water become more intense.

The amount of light reflected depends not only on the viewing angle, but also on the index of refraction (IOR) of the material. At normal incidence (perpendicular to the surface, or 0° angle), the amount of light reflected back is noted $f_{0}$ and can be derived from the IOR as we will see in section [4.8.3.2](#toc4.8.3.2). The amount of light reflected back at grazing angle is noted $f_{90}$ and approaches 100% for smooth materials.

![photo_fresnel_lake.jpg](/images/photo_fresnel_lake.jpg)

> **Figure 10:** The Fresnel effect is particularly evident on large bodies of water

More formally, the Fresnel term defines how light reflects and refracts at the interface between two different media, or the ratio of reflected and transmitted energy. [Schlick94](#citation-schlick94) describes an inexpensive approximation of the Fresnel term for the Cook-Torrance specular BRDF:

$$
 F_{Schlick}(v,h,f_{0},f_{90}) = f_{0} + (f_{90} - f_{0})(1 - v \cdot h)^5
$$

The constant $f_{0}$ represents the specular reflectance at normal incidence and is achromatic for dielectrics, and chromatic for metals. The actual value depends on the index of refraction of the interface. The GLSL implementation of this term requires the use of a `pow`, as shown in [listing 5](#listing_specularf), which can be replaced by a few multiplications.
...
This Fresnel function can be seen as interpolating between the incident specular reflectance and the reflectance at grazing angles, represented here by $f_{90}$. Observation of real world materials show that both dielectrics and conductors exhibit achromatic specular reflectance at grazing angles and that the Fresnel reflectance is 1.0 at 90°. A more correct $f_{90}$ is discussed in section [5.6.2](#toc5.6.2).

Using $f_{90}$ set to 1, the Schlick approximation for the Fresnel term can be optimized for scalar operations by refactoring the code slightly. The result is shown in [listing 6](#listing_scalarspecularf).
...
$$
 f_d(v,l) = \frac{\sigma}{\pi} \frac{1}{| n \cdot v | | n \cdot l |} \int_\Omega D(m,\alpha) G(v,l,m) (v \cdot m) (l \cdot m) dm
$$
...
In practice, the diffuse reflectance $\sigma$ is multiplied later, as shown in [listing 8](#listing_diffusebrdf).
...
However, the diffuse part would ideally be coherent with the specular term and take into account the surface roughness. Both the Disney diffuse BRDF [Burley12](#citation-burley12) and Oren-Nayar model [Oren94](#citation-oren94) take the roughness into account and create some retro-reflection at grazing angles. Given our constraints we decided that the extra runtime cost does not justify the slight increase in quality. This sophisticated diffuse model also renders image-based and spherical harmonics more difficult to express and implement.

For completeness, the Disney diffuse BRDF expressed in [Burley12](#citation-burley12) is the following:
...
The full GLSL implementation of the standard model is shown in [listing 9](#listing_glslbrdf).
...
We mentioned in section [4.3](#toc4.3) that energy conservation is one of the key components of a good BRDF. Unfortunately the BRDFs explored previously suffer from two problems that we will examine below.
...
The Cook-Torrance BRDF we presented earlier attempts to model several events at the microfacet level but does so by accounting for a single bounce of light. This approximation can cause a loss of energy at high roughness, the surface is not energy preserving. [Figure 12](#figure_singlevsmultibounce) shows why this loss of energy occurs. In the single bounce (or single scattering) model, a ray of light hitting the surface can be reflected back onto another microfacet and thus be discarded because of the masking and shadowing term. If we however account for multiple bounces (multiscattering), the same ray of light might escape the microfacet field and be reflected back towards the viewer.

![diagram_single_vs_multi_scatter.png](/images/diagram_single_vs_multi_scatter.png)

> **Figure 12:** Single scattering (left) vs multiscattering

Based on this simple explanation, we can intuitively deduce that the rougher a surface is, the higher the chances are that energy gets lost because of the failure to account for multiple scattering events. This loss of energy appears to darken rough materials. Metallic surfaces are particularly affected because all of their reflectance is specular. This darkening effect is illustrated in [figure 13](#figure_metallicroughenergyloss). With multiscattering, energy preservation can be achieved, as shown in [figure 14](#figure_metallicroughenergypreservation).

![material_metallic_energy_loss.png](/images/material_metallic_energy_loss.png)

> **Figure 13:** Darkening increases with roughness due to single scattering

![material_metallic_energy_preservation.png](/images/material_metallic_energy_preservation.png)

> **Figure 14:** Energy preservation with multiscattering

We can use a white furnace, a uniform lighting environment set to pure white, to validate the energy preservation property of a BRDF. When energy preservation is achieved, a purely reflective metallic surface ($f_{0} = 1$) should be indistinguishable from the background, no matter the roughness of said surface. [Figure 15](#figure_whitefurnaceloss) shows what such a surface looks like with the specular BRDF presented in the previous sections. The loss of energy as the roughness increases is obvious. In contrast, [figure 16](#figure_whitefurnacepreservation) shows that accounting for multiscattering events addresses the energy loss.

![material_furnace_energy_loss.png](/images/material_furnace_energy_loss.png)

> **Figure 15:** Darkening increases with roughness due to single scattering

![material_furnace_energy_preservation.png](/images/material_furnace_energy_preservation.png)

> **Figure 16:** Energy preservation with multiscattering

Multiple-scattering microfacet BRDFs are discussed in depth in [Heitz16](#citation-heitz16). Unfortunately this paper only presents a stochastic evaluation of the multiscattering BRDF. This solution is therefore not suitable for real-time rendering. Kulla and Conty present a different approach in [Kulla17](#citation-kulla17). Their idea is to add an energy compensation term as an additional BRDF lobe shown in equation [energyCompensationLobe](energyCompensationLobe):

$$
 f_{ms}(l,v) = \frac{(1 - E(l)) (1 - E(v)) F_{avg}^2 E_{avg}}{\pi (1 - E_{avg}) (1 - F_{avg}(1 - E_{avg}))}
$$

Where $E$ is the directional albedo of the specular BRDF $f_r$, with $f_{0}$ set to 1:
...
In [Lagarde18](#citation-lagarde18), with credit to Emmanuel Turquin, Lagarde and Golubev make the observation that equation [averageFresnel](averageFresnel) can be simplified to $f_{0}$. They also propose to apply energy compensation by adding a scaled GGX specular lobe:
...
We can implement specular energy compensation at a negligible cost if we store $r$ in the DFG lookup table presented in section [5.3](#toc5.3). [Listing 10](#listing_energycompensationimpl) shows that the implementation is a direct conversion of equation [scaledEnergyCompensationLobe](scaledEnergyCompensationLobe).
...
Please refer to section [5.3](#toc5.3) and section [5.3.4.7](#toc5.3.4.7) to learn how the DFG lookup table is derived and computed.

## Parameterization

Disney's material model described in [Burley12](#citation-burley12) is a good starting point but its numerous parameters makes it impractical for real-time implementations. In addition, we would like our standard material model to be easy to understand and easy to use for both artists and developers.

### Standard parameters

[Table 2](#table_standardparameters) describes the list of parameters that satisfy our constraints.
...
| **Ambient occlusion** | Defines how much of the ambient light is accessible to a surface point. It is a per-pixel shadowing factor between 0.0 and 1.0. This parameter will be discussed in more detail in the [lighting](#lighting) section |

> **Table 2:** Parameters of the standard model

[Figure 17](#figure_material_parameters) shows how the metallic, roughness and reflectance parameters affect the appearance of a surface.

![material_parameters.png](/images/material_parameters.png)
...
It is important to understand the type and range of the different parameters of our material model, described in [table 3](#table_standardparameterstypes).
...
The lighting equations must therefore use the diffuse color and $f_{0}$ instead of the base color. The diffuse color can easily be computed from the base color, as show in [listing 11](#listing_basecolortodiffuse).
...
The Fresnel term relies on $f_{0}$, the specular reflectance at normal incidence angle, and is achromatic for dielectrics. We will use the remapping for dielectric surfaces described in [Lagarde14](#citation-lagarde14) :

$$
 f_{0} = 0.16 \cdot reflectance^2
$$

The goal is to map $f_{0}$ onto a range that can represent the Fresnel values of both common dielectric surfaces (4% reflectance) and gemstones (8% to 16%). The mapping function is chosen to yield a 4% Fresnel reflectance value for an input reflectance of 0.5 (or 128 on a linear RGB gray scale). [Figure 18](#figure_reflectance) show those common values and how they relate to the mapping function.

![diagram_reflectance.png](/images/diagram_reflectance.png)
...
[Table 4](#table_commonmatreflectance) describes acceptable Fresnel reflectance values for various types of materials (no real world material has a value under 2%).
...
[Table 5](#table_fnormalmetals) lists the $f_{0}$ values for a few metals. The values are given in sRGB and must be used as the base color in our material model. Please refer to the annex, section [9.1](#toc9.1), for an explanation of how these sRGB colors are computed from measured data.

| Metal    | $f_{0}$ in sRGB  | Hexadecimal | Color                                                                                             |
| -------- | ---------------- | ----------- | ------------------------------------------------------------------------------------------------- |
| Silver   | 0.97, 0.96, 0.91 | `#f7f4e8`   | <span style={{backgroundColor:"#f7f4e8"}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> |
| Aluminum | 0.91, 0.92, 0.92 | `#e8eaea`   | <span style={{backgroundColor:"#e8eaea"}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> |
| Titanium | 0.76, 0.73, 0.69 | `#c1baaf`   | <span style={{backgroundColor:"#c1baaf"}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> |
| Iron     | 0.77, 0.78, 0.78 | `#c4c6c6`   | <span style={{backgroundColor:"#c4c6c6"}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> |
| Platinum | 0.83, 0.81, 0.78 | `#d3cec6`   | <span style={{backgroundColor:"#d3cec6"}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> |
| Gold     | 1.00, 0.85, 0.57 | `#ffd891`   | <span style={{backgroundColor:"#ffd891"}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> |
| Brass    | 0.98, 0.90, 0.59 | `#f9e596`   | <span style={{backgroundColor:"#f9e596"}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> |
| Copper   | 0.97, 0.74, 0.62 | `#f7bc9e`   | <span style={{backgroundColor:"#f7bc9e"}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> |

> **Table 5:** $f_{0}$ for common metals

All materials have a Fresnel reflectance of 100% at grazing angles so we will set $f_{90}$ in the following way when evaluating the specular BRDF $f_r$:

$$
 f_{90} = 1.0
$$

[Figure 19](#figure_grazing_reflectance) shows a red plastic ball. If you look closely at the edges of the sphere, you will be able to notice the achromatic specular reflectance at grazing angles.

![material_grazing_reflectance.png](/images/material_grazing_reflectance.png)
...
[Listing 12](#listing_fnormal) shows how $f_{0}$ is computed for both dielectric and metallic materials. It shows that the color of the specular reflectance is derived from the base color in the metallic case.

```cpp
vec3 f0 = 0.16 * reflectance * reflectance * (1.0 - metallic) + baseColor * metallic;
```

> **Listing 12:** Computing $f_{0}$ for dielectric and metallic materials in GLSL
...
[Figure 20](#figure_roughness_remap) shows a silver metallic surface with increasing roughness (from 0.0 to 1.0), using the unmodified roughness value (bottom) and the remapped value (top).

![material_roughness_remap.png](/images/material_roughness_remap.png)
...
Brent Burley made similar observations in his presentation [Burley12](#citation-burley12). After experimenting with other remappings (cubic and quadratic mappings for instance), we have reached the conclusion that this simple square remapping delivers visually pleasing and intuitive results while being cheap for real-time applications.
...
As noted in [Burley12](#citation-burley12) and [Neubelt13](#citation-neubelt13), this model allows for robust blending between different materials by simply interpolating the different parameters. In particular, this allows to layer different materials using simple masks.

For instance, [figure 21](#figure_materialblending) shows how the studio Ready at Dawn used material blending and layering in _The Order: 1886_ to create complex appearances from a library of simple materials (gold, copper, wood, rust, etc.).

![material_blending.png](/images/material_blending.png)

> **Figure 21:** Material blending and layering. Source: Ready at Dawn Studios

The blending and layering of materials is effectively an interpolation of the various parameters of the material model. [Figure 22](#figure_material_interpolation) show an interpolation between shiny metallic chrome and rough red plastic. While the intermediate blended materials make little physical sense, they look plausible.

![material_interpolation.png](/images/material_interpolation.png)
...
![material_chart.jpg](/images/material_chart.jpg)
...
![material_clear_coat.png](/images/material_clear_coat.png)
...
Since incoming light will traverse the clear coat layer, we must also take the loss of energy into account as shown in [figure 24](#figure_clearcoatmodel). Our model will however not simulate inter reflection and refraction behaviors.

![diagram_clear_coat.png](/images/diagram_clear_coat.png)

> **Figure 24:** Clear coat surface model

### Clear coat specular BRDF

The clear coat layer will be modeled using the same Cook-Torrance microfacet BRDF used in the standard model. Since the clear coat layer is always isotropic and dielectric, with low roughness values (see section [4.9.3](#toc4.9.3)), we can choose cheaper DFG terms without notably sacrificing visual quality.

A survey of the terms listed in [Karis13a](#citation-karis13a) and [Burley12](#citation-burley12) shows that the Fresnel and NDF terms we already use in the standard model are not computationally more expensive than other terms. [Kelemen01](#citation-kelemen01) describes a much simpler term that can replace our Smith-GGX visibility term:

$$
 V(l,h) = \frac{1}{4(l \cdot h)^2}
$$

This masking-shadowing function is not physically based, as shown in [Heitz14](#citation-heitz14), but its simplicity makes it desirable for real-time rendering.

In summary, our clear coat BRDF is a Cook-Torrance specular microfacet model, with a GGX normal distribution function, a Kelemen visibility function, and a Schlick Fresnel function. [Listing 13](#listing_kelemen) shows how trivial the GLSL implementation is.
...
Because we must take into account the loss of energy caused by the addition of the clear coat layer, we can reformulate the BRDF from equation [brdf](brdf) thusly:
...
The clear coat material model encompasses all the parameters previously defined for the standard material mode, plus two parameters described in [table 6](#table_clearcoatparameters).
...
[Figure 25](#figure_clearcoat) and [figure 26](#figure_clearcoatroughness) show how the clear coat parameters affect the appearance of a surface.

![material_clear_coat1.png](/images/material_clear_coat1.png)

> **Figure 25:** Clear coat varying from 0.0 (left) to 1.0 (right) with metallic set to 1.0 and roughness to 0.8

![material_clear_coat2.png](/images/material_clear_coat2.png)
...
[Listing 14](#listing_clearcoatbrdf) shows the GLSL implementation of the clear coat material model after remapping, parameterization and integration in the standard surface response.
...
The presence of a clear coat layer means that we should recompute $f_{0}$, since it is normally based on an air-material interface. The base layer thus requires $f_{0}$ to be computed based on a clear coat-material interface instead.

This can be achieved by computing the material's index of refraction (IOR) from $f_{0}$, then computing a new $f_{0}$ based on the newly computed IOR and the IOR of the clear coat layer (1.5).
...
Then we compute the new $f_{0}$ from this new index of refraction:
...
This NDF unfortunately relies on two supplemental roughness terms noted $\alpha*b$, the roughness along the bitangent direction, and $\alpha_t$, the roughness along the tangent direction. Neubelt and Pettineo [Neubelt13](#citation-neubelt13) propose a way to derive $\alpha_b$ from $\alpha_t$ by using an _anisotropy\* parameter that describes the relationship between the two roughness values for a material:
...
The relationship defined in [Burley12](#citation-burley12) is different, offers more pleasant and intuitive results, but is slightly more expensive:
...
We instead opted to follow the relationship described in [Kulla17](#citation-kulla17) as it allows creation of sharp highlights:
...
The resulting implementation is described in [listing 15](#listing_anisotropicbrdf).
...
In addition, [Heitz14](#citation-heitz14) presents an anisotropic masking-shadowing function to match the height-correlated GGX distribution. The masking-shadowing term can be greatly simplified by using the visibility function instead:
...
$$
 V_{aniso}(n \cdot l,n \cdot v,\alpha) = \frac{1}{2((n \cdot l)\hat{\Lambda}_v+(n \cdot v)\hat{\Lambda}_l)} \\ \hat{\Lambda}_v = \sqrt{\alpha^2_t(t \cdot v)^2+\alpha^2_b(b \cdot v)^2+(n \cdot v)^2} \\ \hat{\Lambda}_l = \sqrt{\alpha^2_t(t \cdot l)^2+\alpha^2_b(b \cdot l)^2+(n \cdot l)^2}
$$

The term $ \hat{\Lambda}_v $ is the same for every light and can be computed only once if needed. The resulting implementation is described in [listing 16](#listing_anisotropicv).
...
The anisotropic material model encompasses all the parameters previously defined for the standard material mode, plus an extra parameter described in [table 7](#table_anisotropicparameters).
...
No further remapping is required. Note that negative values will align the anisotropy with the bitangent direction instead of the tangent direction. [Figure 28](#figure_anisotropyparameter) shows how the anisotropy parameter affect the appearance of a rough metallic surface.

![materials/anisotropy.png](/images/materials/anisotropy.png)
...
The cloth specular BRDF we use is a modified microfacet BRDF as described by Ashikhmin and Premoze in [Ashikhmin07](#citation-ashikhmin07). In their work, Ashikhmin and Premoze note that the distribution term is what contributes most to a BRDF and that the shadowing/masking term is not necessary for their velvet distribution. The distribution term itself is an inverted Gaussian distribution. This helps achieve fuzz lighting (forward and backward scattering) while an offset is added to simulate the front facing specular contribution. The so-called velvet NDF is defined as follows:

$$
 D_{velvet}(v,h,\alpha) = c_{norm}(1 + 4 exp\left(\frac{-{cot}^2\theta_{h}}{\alpha^2}\right))
$$

This NDF is a variant of the NDF the same authors describe in [Ashikhmin00](#citation-ashikhmin00), notably modified to include an offset (set to 1 here) and an amplitude (4). In [Neubelt13](#citation-neubelt13), Neubelt and Pettineo propose a normalized version of this NDF:

$$
 D_{velvet}(v,h,\alpha) = \frac{1}{\pi(1 + 4\alpha^2)} (1 + 4 \frac{exp\left(\frac{-{cot}^2\theta_{h}}{\alpha^2}\right)}{{sin}^4\theta_{h}})
$$

For the full specular BRDF, we also follow [Neubelt13](#citation-neubelt13) and replace the traditional denominator with a smoother variant:

$$
 f_{r}(v,h,\alpha) = \frac{D_{velvet}(v,h,\alpha)}{4(n \cdot l + n \cdot v - (n \cdot l)(n \cdot v))}
$$

The implementation of the velvet NDF is presented in [listing 17](#listing_clothbrdf), optimized to properly fit in half float formats and to avoid computing a costly cotangent, relying instead on trigonometric identities. Note that we removed the Fresnel component from this BRDF.
...
In [Estevez17](#citation-estevez17) Estevez and Kulla propose a different NDF (called the “Charlie” sheen) that is based on an exponentiated sinusoidal instead of an inverted Gaussian. This NDF is appealing for several reasons: its parameterization feels more natural and intuitive, it provides a softer appearance and, as shown in equation [charlieNDF](charlieNDF), its implementation is simpler:

$$
 D(m) = \frac{(2 + \frac{1}{\alpha}) sin(\theta)^{\frac{1}{\alpha}}}{2 \pi}
$$

[Estevez17](#citation-estevez17) also presents a new shadowing term that we omit here because of its cost. We instead rely on the visibility term from [Neubelt13](#citation-neubelt13) (shown in equation [clothSpecularBRDF](clothSpecularBRDF) above). The implementation of this NDF is presented in [listing 18](#listing_clothcharliebrdf), optimized to properly fit in half float formats.
...
To offer better control over the appearance of cloth and to give users the ability to recreate two-tone specular materials, we introduce the ability to directly modify the specular reflectance. [Figure 31](#figure_materialclothsheen) shows an example of using the parameter we call “sheen color”.
...
Where $F(v,h)$ is the Fresnel term of the cloth specular BRDF in equation [clothSpecularBRDF](clothSpecularBRDF). In practice we've opted to leave out the $1 - F(v, h)$ term in the diffuse component. The effect is a bit subtle and we deemed it wasn't worth the added cost.
...
The complete implementation of our cloth BRDF, including sheen color and optional subsurface scattering, can be found in [listing 19](#listing_clothfullbrdf).
...
The cloth material model encompasses all the parameters previously defined for the standard material mode except for _metallic_ and _reflectance_. Two extra parameters described in [table 8](#table_clothparameters) are also available.
...
**Indirect lighting**: image based lights (IBLs), for both local[2](#endnote-localprobesmobile) and distant light probes.
...
The following sections will discuss how to implement various types of lights and the proposed equations make use of different symbols and units summarized in [table 9](#table_lightunits).
...
[Table 10](#table_lighttypesunits) shows the light unit associated with each type of light we intend to support.
...
However, since artists might be accustomed to gauging a light's brightness by its power, we should allow users to use the power unit to define the brightness of a light. The conversion is presented in equation [radiantPowerToLuminousPower](radiantPowerToLuminousPower).

$$
 \Phi = \Phi_e \eta
$$

In equation [radiantPowerToLuminousPower](radiantPowerToLuminousPower), $\eta$ is the luminous efficacy of the light, expressed in lumens per watt. Knowing that the [maximum possible luminous efficacy](http://en.wikipedia.org/wiki/Luminous_efficacy) is 683 $\frac{lm}{W}$ we can also use luminous efficiency $V$ (also called luminous coefficient), as shown in equation [radiantPowerLuminousEfficiency](radiantPowerLuminousEfficiency).

$$
 \Phi = \Phi_e 683 \times V
$$

[Table 11](#table_lighttypesefficacy) can be used as a reference to convert watts to lumens using either the luminous efficacy or the luminous efficiency of various types of lights. More specific values are available on Wikipedia's [luminous efficacy](http://en.wikipedia.org/wiki/Luminous_efficacy) page.

| Light Type   | Efficacy $\eta$ ($\frac{lm}{W}$) | Efficiency $V$ (%) |
| ------------ | -------------------------------- | ------------------ |
...
The illuminance reaching a surface can be measured using an incident light meter. For our tests, we use a [Sekonic L-478D](http://www.sekonic.com/products/l-478d/overview.aspx), shown in [figure 33](#figure_sekonic).
...
![photo_light_meter.jpg](/images/photo_light_meter.jpg)

> **Figure 33:** Sekonic L-478D incident light meter

#### Luminance

The luminance at a surface, or the product of the incident light and the surface, can be measured using a luminance meter, also often called a spot meter. While incident light meters use a diffuse hemisphere to capture light from all directions, a spot meter uses a shield to measure incident light from a single direction. For our tests, we use a [Sekonic 5° Viewfinder](http://www.sekonic.com/products/l-478dr/accessories/np-finder-5-degree-for-l-478.aspx) that can replace the diffuser on the L-478D to measure luminance in a 5° cone.

![photo_incident_light_meter.jpg](/images/photo_incident_light_meter.jpg)

Sekonic L-478D working as a luminance meter using a special viewfinder

#### Luminous intensity

The luminous intensity of a light source cannot be measured directly but can be derived from the measured illuminance if we know the distance between the measuring device and the light source. Equation [derivedLuminousIntensity](derivedLuminousIntensity) is a simple application of the inverse square law discussed in section [5.2.2](#toc5.2.2).
...
The main purpose of directional lights is to recreate important light sources for outdoor environment, i.e. the sun and/or the moon. While directional lights do not truly exist in the physical world, any light source sufficiently far from the light receptor can be assumed to be directional (i.e. all the incident light rays are parallel, as shown in [figure 34](#figure_directionallight)).

![diagram_directional_light.png](/images/diagram_directional_light.png)
...
We earlier stated that we chose an illuminance light unit ($lx$) for directional lights. This is in part due to the fact that we can easily find illuminance values for the sky and the sun (online or with a light meter) but also to simplify the luminance equation described in [luminanceEquation](luminanceEquation).
...
In the simplified luminance equation [directionalLuminanceEquation](directionalLuminanceEquation), $E_{\bot}$ is the illuminance of the light source for a surface perpendicular to said light source. If the directional light source simulates the sun, $E_{\bot}$ is the illuminance of the sun for a surface perpendicular to the sun direction.

[Table 12](#table_sunskyilluminance) provides useful reference values for the sun and sky illumination, measured[3](#endnote-illuminancemeasures) on a clear day in March, in California.
...
Dynamic directional lights are particularly cheap to evaluate at runtime, as shown in [listing 20](#listing_glsldirectionallight).
...
[Figure 35](#figure_directionallighttest) shows the effect of lighting a simple scene with a directional light setup to approximate a midday Sun (illuminance set to 110,000 $lx$). For illustration purposes, only direct lighting is shown.

![screenshot_directional_light.png](/images/screenshot_directional_light.png)
...
For punctual lights following the inverse square law, the term $E$ of equation [luminanceEquation](luminanceEquation) is expressed in equation [punctualLightEquation](punctualLightEquation), where $d$ is the distance from a point at the surface to the light.
...
A point light is defined only by a position in space, as shown in [figure 36](#figure_pointlight).

![diagram_point_light.png](/images/diagram_point_light.png)

> **Figure 36:** Interaction between a point light and a surface. The attenuation only depends on the distance to the light

The luminous power of a point light is calculated by integrating the luminous intensity over the light's solid angle, as show in equation [pointLightLuminousPower](pointLightLuminousPower). The luminous intensity can then be easily derived from the luminous power.

$$
 \Phi = \int_{\Omega} I dl = \int_{0}^{2\pi} \int_{0}^{\pi} I d\theta d\phi = 4 \pi I \\ I = \frac{\Phi}{4 \pi}
$$

By simple substitution of $I$ in [punctualLightEquation](punctualLightEquation) and $E$ in [luminanceEquation](luminanceEquation) we can formulate the luminance equation of a point light as a function of the luminous power (see [pointLightLuminanceEquation](pointLightLuminanceEquation)).

$$
 L_{out} = f(v,l) \frac{\Phi}{4 \pi d^2} \left< n \cdot l \right>
$$

[Figure 37](#figure_pointlighttest) shows the effect of lighting a simple scene with a point light subject to distance attenuation. Light falloff is exaggerated for illustration purposes.

![screenshot_point_light.png](/images/screenshot_point_light.png)

> **Figure 37:** Inverse square law applied to point lights evaluation

#### Spot lights

A spot light is defined by a position in space, a direction vector and two cone angles, $ \theta*{inner} $ and $ \theta*{outer} $ (see [figure 38](#figure_spotlight)). These two angles are used to define the angular falloff attenuation of the spot light. The light evaluation function of a spot light must therefore take into account both the inverse square law and these two angles to properly evaluate the luminance attenuation.

![diagram_spot_light.png](/images/diagram_spot_light.png)
...
Equation [spotLightLuminousPower](spotLightLuminousPower) describes how the luminous power of a spot light can be calculated in a similar fashion to point lights, using $ \theta_{outer} $ the outer angle of the spot light's cone in the range 0..$\pi$.

$$
 \Phi = \int_{\Omega} I dl = \int_{0}^{2\pi} \int_{0}^{\theta_{outer}} I d\theta d\phi = 2 \pi (1 - cos\frac{\theta_{outer}}{2})I \\ I = \frac{\Phi}{2 \pi (1 - cos\frac{\theta_{outer}}{2})}
$$

While this formulation is physically correct, it makes spot lights a little difficult to use: changing the outer angle of the cone changes the illumination levels. [Figure 39](#figure_spotlighttestfocused) shows the same scene lit by a spot light, with an outer angle of 55° and an outer angle of 15°. Observes how the illumination level increases as the cone aperture decreases.

![screenshot_spot_light_focused.png](/images/screenshot_spot_light_focused.png)

> **Figure 39:** Comparison of spot light outer angles, 55° (left) and 15° (right)

The coupling of illumination and the outer cone means that an artist cannot tweak the influence cone of a spot light without also changing the perceived illumination. It therefore makes sense to provide artists with a parameter to disable this coupling. Equations [spotLightLuminousPowerB](spotLightLuminousPowerB) shows how to formulate the luminous power for that purpose.

$$
 \Phi = \pi I \\ I = \frac{\Phi}{\pi} \\
$$

With this new formulation to compute the luminous intensity, the test scene in [figure 40](#figure_spotlighttest) exhibits similar illumination levels with both cone apertures.

![screenshot_spot_light.png](/images/screenshot_spot_light.png)
...
The term $ \lambda(l) $ in equations [spotAbsorber](spotAbsorber) and [spotReflector](spotReflector) is the spot's angle attenuation factor described in equation [spotAngleAtt](spotAngleAtt) below.
...
The first issue can be solved easily by setting the assumption that punctual lights are not truly punctual but instead small area lights. To do this we can simply treat punctual lights as spheres of 1 cm radius, as show in equation [finitePunctualLight](finitePunctualLight).
...
Mathematically, the illuminance of a light should smoothly reach zero at the limit defined by the influence radius. [Karis13b](#citation-karis13b) proposes to window the inverse square function in such a way that the majority of the light's influence remains unaffected. The proposed windowing is described in equation [attenuationWindowing](attenuationWindowing), where $r$ is the light's radius of influence.

$$
 E = \frac{I}{max(d^2, {0.01}^2)} \left< 1 - \frac{d^4}{r^4} \right>^2
$$

[Listing 21](#listing_glslpunctuallight) demonstrates how to implement physically based punctual lights in GLSL. Note that the light intensity used in this piece of code is the luminous intensity $I$ in $cd$, converted from the luminous power CPU-side. This snippet is not optimized and some of the computations can be offloaded to the CPU (for instance the square of the light's inverse falloff radius, or the spot scale and angle).
...
The lighting system we have described so far can easily address the first two points but we need a way to define the distribution of light within the space. Light distribution is especially important for indoor scenes or for some types of outdoor scenes or even road lighting. [Figure 41](#figure_lightdistributiontest) shows scenes where the light distribution is controlled by the artist. This type of distribution control is widely used when putting objects on display (museums, stores or galleries for instance).

![screenshot_photometric_lights.png](/images/screenshot_photometric_lights.png)
...
The photometric profile can be applied at rendering time as a simple attenuation. The luminance equation [photometricLightEvaluation](photometricLightEvaluation) describes the photometric point light evaluation function.
...
The photometric attenuation function can be easily implemented in GLSL by adding a new attenuation factor to the implementation of punctual lights ([listing 21](#listing_glslpunctuallight)). The modified implementation is show in [listing 22](#listing_glslphotometricpunctuallight).
...
The light intensity is computed CPU-side ([listing 23](#listing_photometriclightintensity)) and depends on whether the photometric profile is used as a mask.
...
The full list of light parameters is presented in [table 13](#table_lightparameters).
...
To compute RGB values from a temperature, we can use the Planckian locus, shown in [figure 44](#figure_planckianlocus). This locus is the path that the color of an incandescent black body takes in a chromaticity space as the body's temperature changes.

![diagram_planckian_locus.png](/images/diagram_planckian_locus.png)

> **Figure 44:** The Planckian locus visualized on a CIE 1931 chromaticity diagram (source: Wikipedia)

The easiest way to compute RGB values from this locus is to use the formula described in [Krystek85](#citation-krystek85). Krystek's algorithm (equation [krystek](krystek)) works in the CIE 1960 (UCS) space, using the following formula where $T$ is the desired temperature, and $u$ and $v$ the coordinates in UCS.

$$
 u(T) = \frac{0.860117757 + 1.54118254 \times 10^{-4}T + 1.28641212 \times 10^{-7}T^2}{1 + 8.42420235 \times 10^{-4}T + 7.08145163 \times 10^{-7}T^2} \\ v(T) = \frac{0.317398726 + 4.22806245 \times 10^{-5}T + 4.20481691 \times 10^{-8}T^2}{1 - 2.89741816 \times 10^{-5}T + 1.61456053 \times 10^{-7}T^2}
$$

This approximation is accurate to roughly $ 9 \times 10^{-5} $ in the range 1,000K to 15,000K. From the CIE 1960 space we can compute the coordinates in xyY space (CIES 1931), using the formula from equation [cieToxyY](cieToxyY).

$$
x = \frac{3u}{2u - 8v + 4} \\ y = \frac{2v}{2u - 8v + 4}
$$

The formulas above are valid for black body color temperatures, and therefore correlated color temperatures of standard illuminants. If we wish to compute the precise chromaticity coordinates of standard CIE illuminants in the D series we can use equation [seriesDtoxyY](seriesDtoxyY).

$$
 x = \begin{cases} 0.244063 + 0.09911 \frac{10^3}{T} + 2.9678 \frac{10^6}{T^2} - 4.6070 \frac{10^9}{T^3} & 4,000K \le T \le 7,000K \\ 0.237040 + 0.24748 \frac{10^3}{T} + 1.9018 \frac{10^6}{T^2} - 2.0064 \frac{10^9}{T^3} & 7,000K \le T \le 25,000K \end{cases} \\ y = -3x^2 + 2.87 x - 0.275
$$

From the xyY space, we can then convert to the CIE XYZ space (equation [xyYtoXYZ](xyYtoXYZ)).

$$
 X = \frac{xY}{y} \\ Z = \frac{(1 - x - y)Y}{y}
$$

For our needs, we will fix $Y = 1$. This allows us to convert from the XYZ space to linear RGB with a simple 3×3 matrix, as shown in equation [XYZtoRGB](XYZtoRGB).
...
The transformation matrix M is calculated from the target RGB color space primaries. Equation [XYZtoRGBValues](XYZtoRGBValues) shows the conversion using the inverse matrix for the sRGB color space.
...
We must finally apply the sRGB opto-electronic conversion function (OECF, shown in equation [OECFsRGB](OECFsRGB)) to obtain a displayable value (the value should remain linear if passed to the renderer for shading).

$$
 C_{sRGB} = \begin{cases} 12.92 \times \hat{C}_{linear} & \hat{C}_{linear} \le 0.0031308 \\ 1.055 \times \hat{C}_{linear}^{\frac{1}{2.4}} - 0.055 & \hat{C}_{linear} \gt 0.0031308 \end{cases}
$$

For convenience, [figure 45](#figure_colortemperaturescalecct) shows the range of correlated color temperatures from 1,000K to 12,500K. All the colors used below assume CIE $ D_{65} $ as the white point (as is the case in the sRGB color space).

![diagram_color_temperature_cct.png](/images/diagram_color_temperature_cct.png)

> **Figure 45:** Scale of correlated color temperatures

Similarly, [figure 46](#figure_colortemperaturescalecie) shows the range of CIE standard illuminants series D from 1,000K to 12,500K.

![diagram_color_temperature_cie.png](/images/diagram_color_temperature_cie.png)

> **Figure 46:** Scale of CIE standard illuminants series D

For reference, [figure 47](#figure_colortemperaturescalecctclamped) shows the range of correlated color temperatures without the normalization step presented in equation [normalizedRGB](normalizedRGB).

![diagram_color_temperature_cct_clamped.png](/images/diagram_color_temperature_cct_clamped.png)

> **Figure 47:** Unnormalized scale of correlated color temperatures

[Table 14](#table_colortemperaturesamples) presents the correlated color temperature of various common light sources as sRGB color swatches. These colors are relative to the $ D_{65} $ white point, so their perceived hue might vary based on your display's white point. See [What colour is the Sun?](http://jila.colorado.edu/~ajsh/colour/Tspectrum.html) for more information.

| Temperature (K)    | Light Source                   | Color                  |
|--------------------|--------------------------------|------------------------|
| 1,700-1,800       | Match flame                    | <span style={{ backgroundColor: "#ff7d00", padding: "10px 20px", display: "inline-block" }}></span> |
| 1,850-1,930       | Candle flame                   | <span style={{ backgroundColor: "#ff8701", padding: "10px 20px", display: "inline-block" }}></span> |
| 2,000-3,000       | Sun at sunrise/sunset          | <span style={{ backgroundColor: "#ffa64c", padding: "10px 20px", display: "inline-block" }}></span> |
| 2,500-2,900       | Household tungsten lightbulb   | <span style={{ backgroundColor: "#ffb05e", padding: "10px 20px", display: "inline-block" }}></span> |
| 3,000             | Tungsten lamp 1K               | <span style={{ backgroundColor: "#ffb86f", padding: "10px 20px", display: "inline-block" }}></span> |
| 3,200-3,500       | Quartz lights                  | <span style={{ backgroundColor: "#ffbf7b", padding: "10px 20px", display: "inline-block" }}></span> |
| 3,200-3,700       | Fluorescent lights             | <span style={{ backgroundColor: "#ffbf7b", padding: "10px 20px", display: "inline-block" }}></span> |
| 3,275             | Tungsten lamp 2K               | <span style={{ backgroundColor: "#ffc180", padding: "10px 20px", display: "inline-block" }}></span> |
| 3,380             | Tungsten lamp 5K, 10K          | <span style={{ backgroundColor: "#ffc486", padding: "10px 20px", display: "inline-block" }}></span> |
| 5,000-5,400       | Sun at noon                    | <span style={{ backgroundColor: "#ffe9d7", padding: "10px 20px", display: "inline-block" }}></span> |
| 5,500-6,500       | Daylight (sun + sky)           | <span style={{ backgroundColor: "#fff3f1", padding: "10px 20px", display: "inline-block" }}></span> |
| 5,500-6,500       | Sun through clouds/haze        | <span style={{ backgroundColor: "#fff3f1", padding: "10px 20px", display: "inline-block" }}></span> |
| 6,000-7,500       | Overcast sky                   | <span style={{ backgroundColor: "#faf6ff", padding: "10px 20px", display: "inline-block" }}></span> |
| 6,500             | RGB monitor white point        | <span style={{ backgroundColor: "#fff8fe", padding: "10px 20px", display: "inline-block" }}></span> |
| 7,000-8,000       | Shaded areas outdoors          | <span style={{ backgroundColor: "#ebecff", padding: "10px 20px", display: "inline-block" }}></span> |
| 8,000-10,000      | Partly cloudy sky              | <span style={{ backgroundColor: "#d6e0ff", padding: "10px 20px", display: "inline-block" }}></span> |
...
Physically based rendering and physical light units pose an interesting challenge: how to store and handle the large range of values produced by the lighting code? Assuming computations performed at full precision in the shaders, we still want to be able to store the linear output of the lighting pass in a reasonably sized buffer (`RGB16F` or equivalent). The most obvious and easiest way to achieve this is to simply apply the camera exposure (see the [Physically based camera](#physicallybasedcamera) section for more information) before writing out the result of the lighting pass. This simple step is shown in [listing 24](#listing_preexposedlighting):
...
![screenshot_ball_ibl.png](/images/screenshot_ball_ibl.png)
...
The radiance $L_{out}$ resulting from the interaction between an image based light's (IBL) irradiance and a material model (BRDF) $f(\Theta)$[5](#endnote-ibl1) is computed as follows:
...
In addition we must distinguish between static and dynamic IBLs. Implementing a fully dynamic day/night cycle requires for instance to recompute the distant light probes dynamically[6](#endnote-ibltypes1). Both planar and screen space reflections are inherently dynamic.

### IBL Unit

As discussed previously in the direct [lighting](#lighting) section, all our lights must use physical units. As such our IBLs will use the luminance unit $\frac{cd}{m^2}$, which is also the output unit of all our direct lighting equations. Using the luminance unit is straightforward for light probes captures by the engine (dynamically or statically offline).
...
Using the Lambertian BRDF[7](#endnote-ibldiffuse1), we get the radiance:
...
$\Omega_s$ is the solid-angle[8](#endnote-ibldiffuse2) associated to sample $i$.

The irradiance integral $E_d$ can be trivially, albeit slowly[9](#endnote-ibldiffuse3), precomputed and stored into a cubemap for efficient access at runtime. Typically, _image_ is a cubemap or an equirectangular image. The term $ \frac{\sigma}{\pi} $ is independent of the IBL and is added at runtime to obtain the _radiance_.

![ibl/ibl_river_roughness_m0.png](/images/ibl/ibl_river_roughness_m0.png)

> **Figure 49:** Image-based environment

![ibl/ibl_irradiance.png](/images/ibl/ibl_irradiance.png)

> **Figure 50:** Image-based irradiance map using the Lambertian BRDF

5 $\Theta$ represents the parameters of the material model $f$, i.e.: _roughness_, albedo and so on...
...
- Very few coefficients are needed to encode $\left< \cos \theta \right> $
- Convolutions by a kernel that _has a circular symmetry_ are very inexpensive and become products in SH space

In practice only 4 or 9 coefficients (i.e.: 2 or 3 bands) are enough for $\left< \cos \theta \right> $ meaning we don't need more either for $L_{\bot}$.

![ibl/ibl_irradiance_sh3.png](/images/ibl/ibl_irradiance_sh3.png)

> **Figure 51:** 3 bands (9 coefficients)

![ibl/ibl_irradiance_sh2.png](/images/ibl/ibl_irradiance_sh2.png)

> **Figure 52:** 2 bands (4 coefficients)

In practice we pre-convolve $L_{\bot}$ with $\left< \cos \theta \right> $ and pre-scale these coefficients by the basis scaling factors $K_l^m$ so that the reconstruction code is as simple as possible in the shader:
...
As we've seen above, the radiance $L_{out}$ resulting from the interaction between an IBL's irradiance and a BRDF is:

$$
 L_{out}(n, v, \Theta) = \int_\Omega f(l, v, \Theta) L_{\bot}(l) \left< n \cdot l \right> \partial l
$$

We recognize the convolution of $L_{\bot}$ by $f(l, v, \Theta) \left< n \cdot l \right>$, i.e.: the environment is _filtered_ using the BRDF as a kernel. Indeed at higher roughness, specular reflections look more _blurry_.

Plugging the expression of $f$ in equation [specularBRDFIntegration](specularBRDFIntegration), we obtain:
...
- $I$ is our original integral, i.e.: $I(g) = \int_\Omega g(l) \left< n \cdot l \right> \partial l$
...
$$
 I( f(\Theta) L_{\bot} ) \approx \tilde{I}( f(\Theta) L_{\bot} ) \\ \tilde{I}( f(\Theta) L_{\bot} ) = K \times \hat{I}( f(\Theta) L_{\bot} ) \\ K = \frac{I(f(\Theta))}{\hat{I}(f(\Theta))}
$$

From the equation above we can see that $\tilde{I}$ is equivalent to $I$ when $L_{\bot}$ is a constant, and yields the correct result:
...
Finally, we can show that the scale factor $K$ satisfies our average irradiance ($\bar{L_{\bot}}$) requirement by plugging $L_{\bot} = \bar{L_{\bot}} + (L_{\bot} - \bar{L_{\bot}}) = \bar{L_{\bot}} + \DeltaL_{\bot}$ into $\tilde{I}$:
...
The above result shows that the average irradiance is computed correctly, i.e.: $I(f(\Theta)\bar{L_{\bot}})$.

A way to think about this approximation is that it splits the radiance $L_{\bot}$ in two parts, the average $\bar{L_{\bot}}$ and the delta from the average $\DeltaL_{\bot}$ and computes the correct integration of the average part then adds the simplified integration of the delta part:
...
$$
 \hat{I}(f(n, \alpha) L_{\bot}) = \int_\Omega f(l, n, \alpha) L_{\bot}(l) \left< n \cdot l \right> \partial l \\ \hat{I}(f(n, \alpha)) = \int_\Omega f(l, n, \alpha) \left< n \cdot l \right> \partial l \\ I(f(n, v, \alpha)) = \int_\Omega f(l, n, v, \alpha) \left< n \cdot l \right> \partial l
$$
...
In the discrete domain the equations in
{/* [iblPartialEquations](iblPartialEquations) */}
become:

$$

 \hat{I}(f(n, \alpha) L_{\bot}) \equiv \frac{1}{N}\sum_{\forall \, i \in image} f(l_i, n, \alpha) L_{\bot}(l_i) \left<n \cdot l\right> \\ \hat{I}(f(n, \alpha)) \equiv \frac{1}{N}\sum_{\forall \, i \in image} f(l_i, n, \alpha) \left<n \cdot l\right> \\ I(f(n, v, \alpha)) \equiv \frac{1}{N}\sum_{\forall \, i \in image} f(l_i, n, v, \alpha) \left<n \cdot l\right>


$$

However, in practice we're using _importance sampling_ which needs to take the $pdf$ of the distribution into account and adds a term $\frac{4\left<v \cdot h\right>}{D(h_i, \alpha)\left<n \cdot h\right>}$. See [Importance Sampling For The IBL](#importancesamplingfortheibl) section:

$$


 \hat{I}(f(n, \alpha) L_{\bot}) \equiv \frac{4}{N}\sum_i^N f(l_i, n, \alpha) \frac{\left<v \cdot h\right>}{D(h_i, \alpha)\left<n \cdot h\right>} L_{\bot}(l_i) \left<n \cdot l\right> \\ \hat{I}(f(n, \alpha)) \equiv \frac{4}{N}\sum_i^N f(l_i, n, \alpha) \frac{\left<v \cdot h\right>}{D(h_i, \alpha)\left<n \cdot h\right>} \left<n \cdot l\right> \\ I(f(n, v, \alpha)) \equiv \frac{4}{N}\sum_i^N f(l_i, n, v, \alpha) \frac{\left<v \cdot h\right>}{D(h_i, \alpha)\left<n \cdot h\right>} \left<n \cdot l\right>
$$

Recalling that for $\hat{I}$, we assume that $v = n$, equations [iblImportanceSampling](iblImportanceSampling), simplifies to:

$$

 \hat{I}(f(n, \alpha) L_{\bot}) \equiv \frac{4}{N}\sum_i^N \frac{f(l_i, n, \alpha)}{D(h_i, \alpha)} L_{\bot}(l_i) \left<n \cdot l\right> \\ \hat{I}(f(n, \alpha)) \equiv \frac{4}{N}\sum_i^N \frac{f(l_i, n, \alpha)}{D(h_i, \alpha)} \left<n \cdot l\right> \\ I(f(n, v, \alpha)) \equiv \frac{4}{N}\sum_i^N \frac{f(l_i, n, v, \alpha)}{D(h_i, \alpha)} \frac{\left<v \cdot h\right>}{\left<n \cdot h\right>} \left<n \cdot l\right>


$$

Then, the first two equations can be merged together such that $LD(n, \alpha) = \frac{\hat{I}(f(n, \alpha) L_{\bot})}{\hat{I}(f(n, \alpha))}$
...
Let's substitute $f$ in equations [iblLD](iblLD) and [iblDFV](iblDFV):
...
Now, let's substitute the fresnel term into equation [iblFV](iblFV):
...
$$
\begin{aligned}
DFG_1(\alpha, \langle n \cdot v \rangle) &= \frac{4}{N} \sum_i^N
\color{green}{(1 - F_c(\langle v \cdot h \rangle))}
V(l_i, v, \alpha)
\frac{\langle v \cdot h \rangle}{\langle n \cdot h \rangle}
\langle n \cdot l \rangle \\
DFG_2(\alpha, \langle n \cdot v \rangle) &= \frac{4}{N} \sum_i^N
\color{green}{F_c(\langle v \cdot h \rangle)}
V(l_i, v, \alpha)
\frac{\langle v \cdot h \rangle}{\langle n \cdot h \rangle}
\langle n \cdot l \rangle \\
I(f(n, v, \alpha)) &\equiv
\color{green}{f_0} \color{red}{DFG_1(\alpha, \langle n \cdot v \rangle)} +
\color{green}{f_{90}} \color{red}{DFG_2(\alpha, \langle n \cdot v \rangle)}
\end{aligned}
$$

Notice that $DFG_1$ and $DFG_2$ only depend on $n \cdot v$, that is the angle between the normal $n$ and the view direction $v$. This is true because the integral is symmetrical with respect to $n$. When integrating, we can choose any $v$ we please as long as it satisfies $n \cdot v$ (e.g.: when calculating $v \cdot h$).
...
Both $DFG_1$ and $DFG_2$ can either be pre-calculated in a regular 2D texture indexed by $(n \cdot v, \alpha)$ and sampled bilinearly, or computed at runtime using an analytic approximation of the surfaces. See sample code in the annex. The pre-calculated textures are shown in [table 15](#table_texturedfg). A C++ implementation of the pre-computation can be found in section [9.5](#toc9.5).

| $DFG_1$                               | $DFG_2$                               | ${ DFG_1, DFG_2, 0 }$               |
| ------------------------------------- | ------------------------------------- | ----------------------------------- |
| ![ibl/dfg1.png](/images/ibl/dfg1.png) | ![ibl/dfg2.png](/images/ibl/dfg2.png) | ![ibl/dfg.png](/images/ibl/dfg.png) |
...
Such analytic approximation is described in [Karis14](#citation-karis14), itself based on [Lazarov13](#citation-lazarov13). [Narkowicz14](#citation-narkowicz14) is another interesting approximation. Note that these two approximations are not compatible with the energy compensation term presented in section [5.3.4.7](#toc5.3.4.7). [Table 16](#table_textureapproxdfg) presents a visual representation of these approximations.

| $DFG_1$ (Approx)                                    | $DFG_2$ (Approx)                                    | ${ DFG_1, DFG_2, 0 }$ (Approx)                    |
| --------------------------------------------------- | --------------------------------------------------- | ------------------------------------------------- |
| ![ibl/dfg1_approx.png](/images/ibl/dfg1_approx.png) | ![ibl/dfg2_approx.png](/images/ibl/dfg2_approx.png) | ![ibl/dfg_approx.png](/images/ibl/dfg_approx.png) |

> **Table 16:** Y axis: $\alpha$. X axis: $cos \theta$

#### The $LD$ term visualized

$LD$ is the convolution of the environment by a function that only depends on the $\alpha$ parameter (itself related to the roughness, see section [4.8.3.3](#toc4.8.3.3)). $LD$ can conveniently be stored in a mip-mapped cubemap where increasing LODs receive the environment pre-filtered with increasing roughness. This works well because this convolution is a powerful low-pass filter. To make good use of each mipmap level, it is necessary to remap $\alpha$; we find that using a power remapping with $\gamma = 2$ works well and is convenient.
...
| Roughness ($\alpha$) | Image                                                                     |
| -------------------- | ------------------------------------------------------------------------- |
| $\alpha=0.0$         | ![ibl/ibl_river_roughness_m0.png](/images/ibl/ibl_river_roughness_m0.png) |
| $\alpha=0.2$         | ![ibl/ibl_river_roughness_m1.png](/images/ibl/ibl_river_roughness_m1.png) |
| $\alpha=0.4$         | ![ibl/ibl_river_roughness_m2.png](/images/ibl/ibl_river_roughness_m2.png) |
| $\alpha=0.6$         | ![ibl/ibl_river_roughness_m3.png](/images/ibl/ibl_river_roughness_m3.png) |
| $\alpha=0.8$         | ![ibl/ibl_river_roughness_m4.png](/images/ibl/ibl_river_roughness_m4.png) |

#### Indirect specular and indirect diffuse components visualized

[Figure 53](#figure_iblvisualized) shows how indirect lighting interacts with dielectrics and conductors. Direct lighting was removed for illustration purposes.

![ibl/ibl_visualization.jpg](/images/ibl/ibl_visualization.jpg)

> **Figure 53:** Indirect diffuse and specular decomposition

#### IBL evaluation implementation

[Listing 27](#listing_iblevaluation) presents a GLSL implementation to evaluate the IBL, using the various textures described in the previous sections.
...
We can however save a couple of texture lookups by using Spherical Harmonics instead of an irradiance cubemap and the analytical approximation of the $DFG$ LUT, as shown in [listing 28](#listing_optimizediblevaluation).
...
In section [4.7.2](#toc4.7.2) we discussed how to use a second scaled specular lobe to compensate for the energy loss due to only accounting for a single scattering event in our BRDF. This energy compensation lobe is scaled by a term that depends on $r$ defined in the following way:
...
Or, evaluated with importance sampling (See [Importance Sampling For The IBL](#importancesamplingfortheibl) section):
...
This equality is very similar to the terms $DFG_1$ and $DFG_2$ seen in equation [iblAllEquations](iblAllEquations). In fact, it's the same, except without the Fresnel term.

By making the further assumption that $f_{90} = 1$, we can rewrite $DFG_1$ and $DFG_2$ and the $L_{out}$ reconstruction:

$$
\begin{align*}
L_{out}(n,v,\alpha,f_0)                           &\simeq \big[ (1 - f_0) \color{red}{DFG_1^{multiscatter}(n \cdot l, \alpha)} + f_0 \color{red}{DFG_2^{multiscatter}(n \cdot l, \alpha)} \big] \times LD(n, \alpha) \\
DFG_1^{multiscatter}(\alpha, \left<n \cdot l\right>) &=      \frac{4}{N}\sum_i^N  \color{green}{F_c(\left<v \cdot h\right>)} V(l_i, v, \alpha)\frac{\left<v \cdot h\right>}{\left<n \cdot h\right>} \left<n \cdot l\right> \\
DFG_2^{multiscatter}(\alpha, \left<n \cdot l\right>) &=      \frac{4}{N}\sum_i^N                                        V(l_i, v, \alpha)\frac{\left<v \cdot h\right>}{\left<n \cdot h\right>} \left<n \cdot l\right> \\
LD(n, \alpha)                                   &=      \frac{\sum_i^N V(l_i, n, \alpha)\left<n \cdot l\right>L_{\bot}(l_i) }{\sum_i^N V(l_i, n, \alpha)\left<n \cdot l\right>}
\end{align*}
$$

These two new $DFG$ terms simply need to replace the ones used in the implementation shown in section [9.5](#toc9.5):
...
To perform the reconstruction we need to slightly modify [listing 30](#listing_multiscatteriblevaluation):
...
![ibl/ibl_prefilter_vs_reference.png](/images/ibl/ibl_prefilter_vs_reference.png)

> **Figure 54:**

![ibl/ibl_stretchy_reflections_error.png](/images/ibl/ibl_stretchy_reflections_error.png)

> **Figure 55:**

![ibl/ibl_trilinear_0.png](/images/ibl/ibl_trilinear_0.png)

> **Figure 56:**

![ibl/ibl_trilinear_1.png](/images/ibl/ibl_trilinear_1.png)

> **Figure 57:**

![ibl/ibl_no_mipmaping.png](/images/ibl/ibl_no_mipmaping.png)

> **Figure 58:**

### Clear coat

When sampling the IBL, the clear coat layer is calculated as a second specular lobe. This specular lobe is oriented along the view direction since we cannot reasonably integrate over the hemisphere. [Listing 31](#listing_clearcoatibl) demonstrates this approximation in practice. It also shows the energy conservation step. It is important to note that this second specular lobe is computed exactly the same way as the main specular lobe, using the same DFG approximation.
...
[McAuley15](#citation-mcauley15) describes a technique called “bent reflection vector”, based [Revie12](#citation-revie12). The bent reflection vector is a rough approximation of anisotropic lighting but the alternative is to use importance sampling. This approximation is sufficiently cheap to compute and provides good results, as shown in [figure 59](#figure_anisotropicibl1) and [figure 60](#figure_anisotropicibl2).

![screenshot_anisotropic_ibl1.jpg](/images/screenshot_anisotropic_ibl1.jpg)
...
![screenshot_anisotropic_ibl2.jpg](/images/screenshot_anisotropic_ibl2.jpg)

> **Figure 60:** Anisotropic reflections with varying roughness, metallicness, etc.

The implementation of this technique is straightforward, as demonstrated in [listing 32](#listing_bentreflectionvector).
...
This technique can be made more useful by accepting negative `anisotropy` values, as shown in [listing 33](#listing_bentreflectionvectordirection). When the anisotropy is negative, the highlights are not in the direction of the tangent, but in the direction of the bitangent instead.
...
[Figure 61](#figure_anisotropicdirection) demonstrates this modified implementation in practice.

![screenshot_anisotropy_direction.png](/images/screenshot_anisotropy_direction.png)
...
The IBL implementation for the cloth material model is more complicated than for the other material models. The main difference stems from the use of a different NDF (“Charlie” vs height-correlated Smith GGX). As described in this section, we use the split-sum approximation to compute the DFG term of the BRDF when computing an IBL. This DFG term is designed for a different BRDF and cannot be used for the cloth BRDF. Since we designed our cloth BRDF to not need a Fresnel term, we can generate a single DG term in the 3rd channel of the DFG LUT. The result is shown in [figure 62](#figure_dfgclothlut).

The DG term is generated using uniform sampling as recommended in [Estevez17](#citation-estevez17). With uniform sampling the $pdf$ is simply $\frac{1}{2\pi}$ and we must still use the Jacobian $\frac{1}{4\left< v \cdot h \right>}$.

![ibl/dfg_cloth.png](/images/ibl/dfg_cloth.png)
...
To properly light a transparent surface, we must first understand how the material's opacity is applied. Observe a window and you will see that the diffuse reflectance is transparent. On the other hand, the brighter the specular reflectance, the less opaque the window appears. This effect can be seen in [figure 63](#figure_cameratransparency): the scene is properly reflected onto the glass surfaces but the specular highlight of the sun is bright enough to appear opaque.

![screenshot_camera_transparency.jpg](/images/screenshot_camera_transparency.jpg)

> **Figure 63:** Example of a complex object where lit surface transparency plays an important role

![screenshot_car.jpg](/images/screenshot_car.jpg)
...
The GLSL implementation of these equations is presented in [listing 35](#listing_surfacetransparency).
...
![screenshot_translucency.png](/images/screenshot_translucency.png)
...
| **Medium scale** | Macro-occlusion used to handle occlusion by an object's own geometry or by geometry baked in normal maps (e.g., bricks). |
| **Large scale**  | Occlusion coming from contact between objects or from an object's own geometry.                                          |

We currently ignore micro-occlusion, which is often exposed in tools and engines under the form of a “cavity map”. Sébastien Lagarde offers an interesting discussion in [Lagarde14](#citation-lagarde14) on how micro-occlusion is handled in Frostbite: diffuse micro-occlusion is pre-baked in diffuse maps and specular micro-occlusion is pre-baked in reflectance textures. In our system, micro-occlusion can simply be baked in the base color map. This must be done knowing that the specular light will not be affected by micro-occlusion.

Medium scale ambient occlusion is pre-baked in ambient occlusion maps, exposed as a material parameter, as seen in the material [parameterization](#parameterization) section earlier.

Large scale ambient occlusion is often computed using screen-space techniques such as _SSAO_ (screen-space ambient occlusion), _HBAO_ (horizon based ambient occlusion), etc. Note that these techniques can also contribute to medium scale ambient occlusion when the camera is close enough to surfaces.
...
This expression can be approximated by separating the visibility term from the illumination function, as shown in equation [diffuseAOApprox](diffuseAOApprox).
...
The left term of this approximation is the pre-computed diffuse component of our IBL. The right term is a scalar factor between 0 and 1 that indicates the fractional accessibility of a point. Its opposite is the diffuse ambient occlusion term, show in equation [diffuseAOTerm](diffuseAOTerm).
...
[Figure 66](#figure_aocomparison) shows two different materials without and with diffuse ambient occlusion. Notice how the material ambient occlusion is used to recreate the natural shadowing that occurs between the different tiles. Without ambient occlusion, both materials appear too flat.
...
Applying baked diffuse ambient occlusion in a GLSL shader is straightforward, as shown in [listing 36](#listing_bakeddiffuseao).
...
When computing the specular IBL contribution for a surface that uses a normal map, it is possible to end up with a reflection vector pointing towards the surface. If this reflection vector is used for shading directly, the surface will be lit in places where it should not be lit (assuming opaque surfaces). This is another occurrence of light leaking that can easily be minimized using a simple technique described by Jeff Russell [Russell15](#citation-russell15).

The key idea is to occlude light coming from behind the surface. This can easily be achieved since a negative dot product between the reflected vector and the surface's normal indicates a reflection vector pointing towards the surface. Our implementation shown in [listing 39](#listing_horizonocclusion) is similar to Russell's, albeit without the artist controlled horizon fading factor.
...
![screenshot_normal_map.jpg](/images/screenshot_normal_map.jpg)

> **Figure 68:** Normal map used as a base map

A simple problem arises if we now want to combine this base map with a second normal map. For instance, let's use the detail map shown in [figure 69](#figure_detailnormalmap) to add cracks in the leather.

![screenshot_normal_map_detail.jpg](/images/screenshot_normal_map_detail.jpg)
...
Colin Barré-Brisebois and Stephen Hill propose in [Hill12](#citation-hill12) a mathematically sound solution called _Reoriented Normal Mapping_, which consists in rotating the basis of the detail map onto the normal from the base map. This technique relies on the shortest arc quaternion to apply the rotation, which greatly simplifies thanks to the properties of the tangent space.

Following the simplifications described in [Hill12](#citation-hill12), we can produce the GLSL implementation shown in [listing 40](#listing_reorientednormalmapping).
...
Since this technique is slightly more expensive than the one described below, we will mostly use it offline. We therefore provide a simple offline tool to combine two normal maps. [Figure 70](#figure_blendednormalmaps) presents the output of the tool with the base map and the detail map shown previously.

![screenshot_normal_map_blended.jpg](/images/screenshot_normal_map_blended.jpg)

> **Figure 70:** Blended normal and detail map (left) and resulting render when combined with a diffuse map (right)

### UDN blending

The technique called UDN blending, described in [Hill12](#citation-hill12), is a variant of the partial derivative blending technique. Its main advantage is the low number of shader instructions it requires (see [listing 41](#listing_udnblending)). While it leads to a reduction in details over flat areas, UDN blending is interesting if blending must be performed at runtime.
...
The results are visually close to Reoriented Normal Mapping but a careful comparison of the data shows that UDN is indeed less correct. [Figure 71](#figure_blendednormalmapsudn) presents the result of the UDN blending approach using the same source data as in the previous examples.

![screenshot_normal_map_blended_udn.jpg](/images/screenshot_normal_map_blended_udn.jpg)
...
![screenshot_fog1.jpg](/images/screenshot_fog1.jpg)

> **Figure 72:** Example of directional in-scattering with exponential height fog

![screenshot_fog2.jpg](/images/screenshot_fog2.jpg)
...
**Note**: the _OETF_ step is the application of the opto-electronic transfer function of the target color space. For clarity this diagram does not include post-processing steps such as vignette, bloom, etc. These effects will be discussed separately.
...
| ------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Aperture ($ƒ/N$)**     | Controls the size of the camera's aperture. Higher values ($ƒ/16$) indicate a smaller aperture, while lower values ($ƒ/1.4$) indicate a wider aperture. Affects exposure and depth of field. |
| **Shutter speed ($t$)**  | Expressed in seconds ($s$). Controls how long the aperture remains open, affecting exposure and motion blur.                                                                                 |
| **Sensitivity (S, ISO)** | Expressed in ISO. Controls how light is quantized by the sensor. Higher ISO values increase brightness but also introduce noise.                                                             |

### Exposure value

Since referring to these 3 settings in our equations would be unwieldy, we instead summarize the “exposure triangle” by an exposure value, noted EV[10](#endnote-reciprocity).
...
Equation [ev](ev) shows the [formal definition of EV](https://en.wikipedia.org/wiki/Exposure_value).
...
Note that this definition is only function of the aperture and shutter speed, but not the sensitivity. An exposure value is by convention defined for ISO 100, or $ EV*{100} $, and because we wish to work with this convention, we need to be able to express $ EV*{100} $ as a function of the sensitivity.

Since we know that EV is a base-2 logarithmic scale in which each stop increases or decreases the brightness by a factor of 2, we can formally define $ EV_{S} $, the exposure value at given sensitivity (equation [evS](evS)).
...
Calculating the $ EV_{100} $ as a function of the 3 camera settings is trivial, as shown in [ev100](ev100).
...
It is possible to define EV as a function of the scene luminance $L$, given a per-device calibration constant $K$ (equation [evK](evK)).
...
Since we want to work with $ EV_{100} $, we can substitute $K$ and $S$ in equation [evK](evK) to obtain equation [ev100L](ev100L).
...
Since we want to work with $ EV_{100} $, we can substitute $S$ [evC](evC) to obtain equation [ev100C](ev100C).

$$
EV = log_2(E \frac{100}{C})
$$

The illuminance can then be computed from a given EV. For a flat sensor with $ C = 250 $ we obtain equation [eFlatSensor](eFlatSensor).

$$
E = 2^{EV_{100}} \times 2.5
$$

For a hemispherical sensor with $ C = 340 $ we obtain equation [eHemisphereSensor](eHemisphereSensor)
...
Applying an exposure compensation $EC$ is a simple as adding an offset to the exposure value, as shown in equation [ec](ec).
...
To convert the scene luminance into normalized luminance, we must use the [photometric exposure](https://en.wikipedia.org/wiki/Exposure_value#Camera_settings_vs._photometric_exposure) (or luminous exposure), or amount of scene luminance that reaches the camera sensor. The photometric exposure, expressed in lux seconds and noted $H$, is given by equation [photometricExposure](photometricExposure).

$$
H = \frac{q \cdot t}{N^2} L
$$

Where $L$ is the luminance of the scene, $t$ the shutter speed, $N$ the aperture and $q$ the lens and vignetting attenuation (typically $ q = 0.65 $[11](#endnote-lensattenuation)). This definition does not take the sensor sensitivity into account. To do so, we must use one of the three ways to relate photometric exposure and sensitivity: saturation-based speed, noise-based speed and standard output sensitivity.

We choose the saturation-based speed relation, which gives us $ H_{sat} $, the maximum possible exposure that does not lead to clipped or bloomed camera output (equation [hSat](hSat)).

$$
H_{sat} = \frac{78}{S_{sat}}
$$

We combine equations [hSat](hSat) and [photometricExposure](photometricExposure) in equation [lmax](lmax) to compute the maximum luminance $ L_{max} $ that will saturate the sensor given exposure settings $S$, $N$ and $t$.

$$
L_{max} = \frac{N^2}{q \cdot t} \frac{78}{S}
$$

This maximum luminance can then be used to normalize incident luminance $L$ as shown in equation [normalizedLuminance](normalizedLuminance).
...
$ L_{max} $ can be simplified using equation [ev](ev), $ S = 100 $ and $ q = 0.65 $:
...
[Listing 42](#listing_fragmentexposure) shows how the exposure term can be applied directly to the pixel color computed in a fragment shader.
...
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------ |
| **Spot metering**              | A small circle in the center (1-5% of the image) determines the exposure.                                          |
| **Center-weighted metering**   | Gives more weight to luminance values in the center of the image.                                                  |
| **Multi-zone/matrix metering** | Uses a grid to analyze the scene and prioritizes exposure for key elements, sometimes comparing to known datasets. |

#### Spot metering

The weight $w$ of each luminance value to use when computing the scene luminance is given by equation [spotMetering](spotMetering).
...
To smooth the result of the metering, we can use equation [adaptation](adaptation), an exponential feedback loop as described by Pattanaik et al. in Pattanaik00.
...
![screenshot_bloom.jpg](/images/screenshot_bloom.jpg)

> **Figure 74:** Saturated photosites on a sensor create a blooming effect in the bright parts of the scene

With $c$ the bloom color and $ EV_{100} $ the current exposure value, we can easily compute the luminance of the bloom value as show in equation [bloomEV](bloomEV).

$$
EV_{bloom} = EV_{100} + EC \\ L_{bloom} = c \times 2^{EV_{bloom} - 3}
$$

Equation [bloomEV](bloomEV) can be used in a fragment shader to implement emissive blooms, as shown in [listing 43](#listing_fragmentemissive).
...
![screenshot_fringing.jpg](/images/screenshot_fringing.jpg)
...
The scene displayed in [figure 76](#figure_sponza) was rendered using clustered forward rendering.

![screenshot_sponza.jpg](/images/screenshot_sponza.jpg)

> **Figure 76:** Clustered forward rendering with dozens of dynamic lights and MSAA

[Figure 77](#figure_sponzatiles) shows the same scene split in tiles (in this case, a 1280×720 render target with 80×80px tiles).

![screenshot_sponza_tiles.jpg](/images/screenshot_sponza_tiles.jpg)
...
The frustum is first sliced on the depth axis as show in [figure 78](#figure_sponzaslices).

![screenshot_sponza_slices.jpg](/images/screenshot_sponza_slices.jpg)

> **Figure 78:** Depth slicing (16 slices)

And the depth slices are then combined with the screen tiles to “voxelize” the frustum. We call each cluster a froxel as it makes it clear what they represent (a voxel in frustum space). The result of the “froxelization” pass is shown in [figure 79](#figure_froxel1) and [figure 80](#figure_froxel2).

![screenshot_sponza_froxels1.jpg](/images/screenshot_sponza_froxels1.jpg)

> **Figure 79:** Frustum voxelization (5×3 tiles, 8 depth slices)

![screenshot_sponza_froxels2.jpg](/images/screenshot_sponza_froxels2.jpg)
...
[Figure 81](#figure_froxeldistribution) shows how much world space unit each depth slice uses with exponential slicing.

![diagram_froxels1.png](/images/diagram_froxels1.png)

> **Figure 81:** Near: 0.1m, Far: 100m, 16 slices

A simple exponential voxelization is unfortunately not enough. The graphic above clearly illustrates how world space is distributed across slices but it fails to show what happens close to the near plane. If we examine the same distribution in a smaller range (0.1m to 7m) we can see an interesting problem appear as shown in [figure 82](#figure_froxeldistributionclose).

![diagram_froxels2.png](/images/diagram_froxels2.png)
...
Our solution is to manually tweak the size of the first froxel depending on the scene and the near and far planes. By doing so, we can better distribute the remaining froxels across the frustum. [Figure 83](#figure_froxeldistributionexp) shows for instance what happens when we use a special froxel between 0.1m and 5m.

![diagram_froxels3.png](/images/diagram_froxels3.png)
...
Given a near plane $n$, a far plane $f$, a maximum number of depth slices $m$ and a linear depth value $z$ in the range 0..1, equation [zToCluster](zToCluster) can be used to compute the index of the cluster for a given position.
...
Equation [linearZ](linearZ) can be used to compute a linear depth value from `gl_FragCoord.z` (assuming a standard OpenGL projection matrix).

$$
linearZ(z)=\frac{n}{f+z(n-f)}
$$

This equation can be simplified by pre-computing two terms $c0$ and $c1$, as shown in equation [linearZFix](linearZFix).

$$
c1 = \frac{f}{n} \\ c0 = 1 - c1 \\ linearZ(z)=\frac{1}{z \cdot c0 + c1}
$$

This simplification is important because we pass the linear z value to a `log2` in [zToClusterFix](zToClusterFix). Since the division becomes a negation under a logarithmic, we can avoid a division by using $-log2(z \cdot c0 + c1)$ instead.

All put together, computing the froxel index of a given fragment can be implemented fairly easily as shown in [listing 44](#listing_fragcoordtofroxel).
...
Given a froxel index $i$, a special near plane $sn$, a far plane $f$ and a maximum number of depth slices $m$, equation [clusterToZ](clusterToZ) computes the minimum depth of a given froxel.
...
With emissive materials and IBLs, it is fairly easy to obtain a scene in which specular highlights are brighter than their apparent caster. This type of issue can be difficult to observe after tone-mapping and quantization but is fairly obvious in the scene-referred space. [Figure 84](#figure_luminanceviz) shows how the custom operator described in [listing 45](#listing_tonemapluminanceviz) is used to show the exposed luminance of a scene.

![screenshot_luminance_debug.png](/images/screenshot_luminance_debug.png)
...
[Figure 85](#figure_mitsubareference) and [figure 86](#figure_filamentreference) show a simple scene, a perfectly smooth dielectric sphere, rendered respectively with Mitsuba and Filament.

![screenshot_ref_mitsuba.jpg](/images/screenshot_ref_mitsuba.jpg)

> **Figure 85:** Rendered in 2048×1440 in 1 minute and 42 seconds on a 12 core 2013 MacPro

![screenshot_ref_filament.jpg](/images/screenshot_ref_filament.jpg)
...
[Figure 87](#figure_referencecomparison) shows the luminance gradient of the images produced by both engines. The comparison was performed on LDR images.

![screenshot_ref_comparison.png](/images/screenshot_ref_comparison.png)
...
![screenshot_coordinates.jpg](/images/screenshot_coordinates.jpg)
...
All cubemaps used in Filament follow the OpenGL convention for face alignment shown in [figure 89](#figure_cubemapcoordinates).

![screenshot_cubemap_coordinates.png](/images/screenshot_cubemap_coordinates.png)

> **Figure 89:** Horizontal cross representation of a cubemap following the OpenGL faces alignment convention.

Note that environment background and reflection probes are mirrored (see section [8.6.3.1](#toc8.6.3.1)).
...
When specifying a skybox or an IBL in Filament, the specified cubemap is oriented such that its -Z face points towards the +Z axis of the world (this is because filament assumes mirrored cubemaps, see section [8.6.3.1](#toc8.6.3.1)). However, because environments and skyboxes are expected to be pre-mirrored, their -Z (back) face points towards the world's -Z axis as expected (and the camera looks toward that direction by default, see section [8.6.2](#toc8.6.2)).

# Annex

## Specular color

The specular color of a metallic surface, or $f_{0}$, can be computed directly from measured spectral data. Online databases such as [Refractive Index](https://refractiveindex.info/?shelf=3d&book=metals&page=brass) provide tables of complex IOR measured at different wavelengths for various materials.

Earlier in this document, we presented equation [fresnelEquation](fresnelEquation) to compute the Fresnel reflectance at normal incidence for a dielectric surface given its IOR. The same equation can be rewritten for conductors by using complex numbers to represent the surface's IOR:

$$
c_{ior} = n_{ior} + ik
$$

Equation [fresnelComplexIOR](fresnelComplexIOR) presents the resulting Fresnel formula, where $c^*$ is the conjugate of the complex number $c$:
...
In the discrete domain, the integral can be approximated with sampling as defined in equation [iblSampling](iblSampling).
...
Unfortunately, we would need too many samples to evaluate this integral. A technique commonly used is to choose samples that are more “important” more often, this is called _importance sampling_. In our case we'll use the distribution of micro-facets normals, $D_{ggx}$, as the distribution of important samples.

The evaluation of $ L_{out}(n,v,\Theta) $ with importance sampling is presented in equation [annexIblImportanceSampling](annexIblImportanceSampling).
...
In equation [annexIblImportanceSampling](annexIblImportanceSampling), $p$ is the probability density function (PDF) of the distribution of _important direction samples_ $l_i$. These samples depend on $h_i$, $v$ and $\alpha$. The definition of the PDF is shown in equation [iblPDF](iblPDF).

$h_i$ is given by the distribution we chose, see section [9.2.1](#toc9.2.1) for more details.

The _important direction samples_ $l_i$ are calculated as the reflection of $v$ around $h_i$, and therefore **do not** have the same PDF as $h_i$. The PDF of a transformed distribution is given by:
...
Where $|J(T_r)|$ is the determinant of the Jacobian of the transform. In our case we're considering the transform from $h_i$ to $l_i$ and the determinant of its Jacobian is given in [iblPDF](iblPDF).

$$

 p(l,v,\Theta) = D(h,\alpha) \left< n \cdot h \right> |J_{h \rightarrow l}|^{-1} \\ |J_{h \rightarrow l}| = 4 \left< v \cdot h \right>
...
Refer to section [9.3](#toc9.3) for more details. Given a uniform distribution $(\zeta_{\phi},\zeta_{\theta})$ the important direction $l$ is defined by equation [importantDirection](importantDirection).
...
Typically, $ (\zeta*{\phi},\zeta*{\theta}) $ are chosen using the Hammersley uniform distribution algorithm described in section [9.4](#toc9.4).
...
This technique is described in details in [Krivanek08](#citation-krivanek08).
...
[Table 17](#table_importancesamplingviz) shows a comparison between importance sampling and pre-filtered importance sampling when applied to [figure 90](#figure_importancesamplingref).

![image_is_original.png](/images/image_is_original.png)

> **Figure 90:** Importance sampling image reference

| Samples | Importance Sampling                             | Pre-filtered Importance Sampling                  |
| ------- | ----------------------------------------------- | ------------------------------------------------- |
| 4096    | ![image_is_4096.png](/images/image_is_4096.png) |                                                   |
| 1024    | ![image_is_1024.png](/images/image_is_1024.png) | ![image_fis_1024.png](/images/image_fis_1024.png) |
| 32      | ![image_is_32.png](/images/image_is_32.png)     | ![image_fis_32.png](/images/image_fis_32.png)     |
...
| ![image_is_ref_1.png](/images/image_is_ref_1.png) | ![image_filtered_1.png](/images/image_filtered_1.png) |
| ------------------------------------------------- | ----------------------------------------------------- |
| ![image_is_ref_2.png](/images/image_is_ref_2.png) | ![image_filtered_2.png](/images/image_filtered_2.png) |
| ![image_is_ref_3.png](/images/image_is_ref_3.png) | ![image_filtered_3.png](/images/image_filtered_3.png) |
| ![image_is_ref_4.png](/images/image_is_ref_4.png) | ![image_filtered_4.png](/images/image_filtered_4.png) |
...
The PDF of the BRDF can therefore be expressed as in equation [importantPDF](importantPDF):
...
We set $ P(s*{\phi}) $ and $ P(s*{\theta}) $ to random variables $ \zeta*{\phi} $ and $ \zeta*{\theta} $ and solve for $ s*{\phi} $ and $ s*{\theta} $ respectively:
...
So given a uniform distribution $ (\zeta*{\phi},\zeta*{\theta}) $, our important direction $l$ is defined as:
...
The term $ L*{DFG} $ is only dependent on $ n \cdot v $. Below, the normal is arbitrarily set to $ n = [left0, 0, 1 ] $ and $v$ is chosen to satisfy $ n \cdot v $. The vector $ h_i $ is the $ D*{GGX}(\alpha) $ important direction sample $i$.
...
C++ implementation of the $ L_{\text{DFG}}$ term
...
$$
\begin{equation} Y^m_l(\theta, \phi) = K^m_l e^{im\theta} P^{|m|}_l(cos \theta), l \in N, -l <= m <= l
\end{equation}
$$
...
Computing $y^{|m|}_l$ requires to compute $P^{|m|}_l(z)$ first. This can be accomplished fairly easily using the recursions in equation [shRecursions](shRecursions). The third recursion can be used to “move diagonally” in [table 20](#table_basisfunctions), i.e. calculating $y^0_0$, $y^1_1$, $y^2_2$ etc. Then, the fourth recursion can be used to move vertically.

| Band index ($l$) | Basis functions ($-l \leq m \leq l$)              |
| ---------------- | ------------------------------------------------- |
| $l = 0$          | $y^0_0$                                           |
...
[Listing 47](#listing_nonnormalizedshbasis) shows the C++ code to compute the non-normalized SH basis $\frac{y^m_l(s)}{\sqrt{2} K^m_l}$:
...
In [Ramamoorthi01](#citation-ramamoorthi01) an analytical solution to the integral is described:
...
Very few coefficients are needed to reasonably approximate $\left< cos \theta \right>$, as shown in [figure 91](#figure_shcosthetaapprox).

![chart_sh_cos_thera_approx.png](/images/chart_sh_cos_thera_approx.png)
...
Assigning lights to froxels can be implemented on the GPU using two compute shaders. The first one, shown in [listing 48](#listing_froxelgeneration), creates the froxels data (4 planes + a min Z and max Z per froxel) in an SSBO and needs to be run only once. The shader requires the following uniforms:

| Parameter                     | Definition                                                                                                                                                                     |
| ----------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Projection matrix**         | The projection matrix used to render the scene (view space to clip space transformation).                                                                                      |
| **Inverse projection matrix** | The inverse of the projection matrix used to render the scene (clip space to view space transformation).                                                                       |
| **Depth parameters**          | $-log2(\frac{z_{near}}{z_{far}}) \frac{1}{maxSlices-1}$, maximum number of depth slices, Z near and Z far.                                                                     |
| **Clip space size**           | $\frac{F_x \times F_r}{w} \times 2$, with $F_x$ the number of tiles on the X axis, $F_r$ the resolution in pixels of a tile, and $w$ the width in pixels of the render target. |
...
The second compute shader, shown in [listing 49](#listing_froxelevaluation), runs every frame (if the camera and/or lights have changed) and assigns all the lights to their respective froxels. This shader relies only on a couple of uniforms (the number of point/spot lights and the view matrix) and four SSBOs:

| Parameter               | Definition                                                                                                                                                                                                                                                                                                                                                                               |
| ----------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Light index buffer**  | For each froxel, the index of each light that affects said froxel. The indices for point lights are written first, and if there is enough space left, the indices for spot lights are written as well. A sentinel of value `0x7fffffffu` separates point and spot lights and/or marks the end of the froxel's list of lights. Each froxel has a maximum number of lights (point + spot). |
| **Point lights buffer** | Array of structures describing the scene's point lights.                                                                                                                                                                                                                                                                                                                                 |
| **Spot lights buffer**  | Array of structures describing the scene's spot lights.                                                                                                                                                                                                                                                                                                                                  |
| **Froxels buffer**      | The list of froxels represented by planes, created by the previous compute shader.                                                                                                                                                                                                                                                                                                       |
...
- **Ashdown98** Ian Ashdown. 1998. Parsing the IESNA LM-63 photometric data file. [http://lumen.iee.put.poznan.pl/kw/iesna.txt](http://lumen.iee.put.poznan.pl/kw/iesna.txt)
- **Ashikhmin00** Michael Ashikhmin, Simon Premoze and Peter Shirley. A Microfacet-based BRDF Generator. _SIGGRAPH '00 Proceedings_, 65-74.
- **Ashikhmin07** Michael Ashikhmin and Simon Premoze. 2007. Distribution-based BRDFs.
- **Burley12** Brent Burley. 2012. Physically Based Shading at Disney. _Physically Based Shading in Film and Game Production, ACM SIGGRAPH 2012 Courses_.
- **Estevez17** Alejandro Conty Estevez and Christopher Kulla. 2017. Production Friendly Microfacet Sheen BRDF. _ACM SIGGRAPH 2017_.
- **Hammon17** Earl Hammon. 217. PBR Diffuse Lighting for GGX+Smith Microsurfaces. _GDC 2017_.
- **Heitz14** Eric Heitz. 2014. Understanding the Masking-Shadowing Function in Microfacet-Based BRDFs. _Journal of Computer Graphics Techniques_, 3 (2).
- **Heitz16** Eric Heitz et al. 2016. Multiple-Scattering Microfacet BSDFs with the Smith Model. _ACM SIGGRAPH 2016_.
- **Hill12** Colin Barré-Brisebois and Stephen Hill. 2012. Blending in Detail. [http://blog.selfshadow.com/publications/blending-in-detail/](http://blog.selfshadow.com/publications/blending-in-detail/)
- **Karis13a** Brian Karis. 2013. Specular BRDF Reference. [http://graphicrants.blogspot.com/2013/08/specular-brdf-reference.html](http://graphicrants.blogspot.com/2013/08/specular-brdf-reference.html)
- **Karis13b** Brian Karis, 2013. Real Shading in Unreal Engine 4. [https://blog.selfshadow.com/publications/s2013-shading-course/karis/s2013_pbs_epic_notes_v2.pdf](https://blog.selfshadow.com/publications/s2013-shading-course/karis/s2013_pbs_epic_notes_v2.pdf)
- **Karis14** Brian Karis. 2014. Physically Based Shading on Mobile. [https://www.unrealengine.com/blog/physically-based-shading-on-mobile](https://www.unrealengine.com/blog/physically-based-shading-on-mobile)
- **Kelemen01** Csaba Kelemen et al. 2001. A Microfacet Based Coupled Specular-Matte BRDF Model with Importance Sampling. _Eurographics Short Presentations_.
- **Krystek85** M. Krystek. 1985. An algorithm to calculate correlated color temperature. _Color Research & Application_, 10 (1), 38-40.
- **Krivanek08** Jaroslave Krivànek and Mark Colbert. 2008. Real-time Shading with Filtered Importance Sampling. _Eurographics Symposium on Rendering 2008_, Volume 27, Number 4.
- **Kulla17** Christopher Kulla and Alejandro Conty. 2017. Revisiting Physically Based Shading at Imageworks. _ACM SIGGRAPH 2017_
- **Lagarde14** Sébastien Lagarde and Charles de Rousiers. 2014. Moving Frostbite to PBR. _Physically Based Shading in Theory and Practice, ACM SIGGRAPH 2014 Courses_.
- **Lagarde18** Sébastien Lagarde and Evgenii Golubev. 2018. The road toward unified rendering with Unity's high definition rendering pipeline. _Advances in Real-Time Rendering in Games, ACM SIGGRAPH 2018 Courses_.
- **Lazarov13** Dimitar Lazarov. 2013. Physically-Based Shading in Call of Duty: Black Ops. _Physically Based Shading in Theory and Practice, ACM SIGGRAPH 2013 Courses_.
- **McAuley15** Stephen McAuley. 2015. Rendering the World of Far Cry 4. _GDC 2015_.
- **McGuire10** Morgan McGuire. 2010. Ambient Occlusion Volumes. _High Performance Graphics_.
- **Narkowicz14** Krzysztof Narkowicz. 2014. Analytical DFG Term for IBL. [https://knarkowicz.wordpress.com/2014/12/27/analytical-dfg-term-for-ibl](https://knarkowicz.wordpress.com/2014/12/27/analytical-dfg-term-for-ibl)
- **Neubelt13** David Neubelt and Matt Pettineo. 2013. Crafting a Next-Gen Material Pipeline for The Order: 1886. _Physically Based Shading in Theory and Practice, ACM SIGGRAPH 2013 Courses_.
- **Oren94** Michael Oren and Shree K. Nayar. 1994. Generalization of lambert's reflectance model. _SIGGRAPH_, 239-246. ACM.
- **Pattanaik00** Sumanta Pattanaik00 et al. 2000. Time-Dependent Visual Adaptation For Fast Realistic Image Display. _SIGGRAPH '00 Proceedings of the 27th annual conference on Computer graphics and interactive techniques_, 47-54.
- **Ramamoorthi01** Ravi Ramamoorthi and Pat Hanrahan. 2001. On the relationship between radiance and irradiance: determining the illumination from images of a convex Lambertian object. _Journal of the Optical Society of America_, Volume 18, Number 10, October 2001.
- **Revie12** Donald Revie. 2012. Implementing Fur in Deferred Shading. _GPU Pro 2_, Chapter 2.
- **Russell15** Jeff Russell. 2015. Horizon Occlusion for Normal Mapped Reflections. [http://marmosetco.tumblr.com/post/81245981087](http://marmosetco.tumblr.com/post/81245981087)
- **Schlick94** Christophe Schlick. 1994. An Inexpensive BRDF Model for Physically-Based Rendering. _Computer Graphics Forum_, 13 (3), 233-246.
- **Walter07** Bruce Walter et al. 2007. Microfacet Models for Refraction through Rough Surfaces. _Proceedings of the Eurographics Symposium on Rendering_.
