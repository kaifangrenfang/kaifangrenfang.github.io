...
L_{max} &= \frac{N^2}{t} \frac{78}{q \cdot S} \\ L_{max} &= 2^{EV_{100}} \frac{78}{q \cdot S} \\ L_{max} &= 2^{EV_{100}} \times 1.2
...
lod &= log_4 \left( K\frac{\Omega_s}{\Omega_p} \right) \\ K &= 4.0 \\ \Omega_s &= \frac{1}{N \cdot p(l_i)} \\ \Omega_p &\approx \frac{4\pi}{6 \cdot width \cdot height}
...
![image_is_ref_1.png](/images/image_is_ref_1.png)

![image_filtered_1.png](/images/image_filtered_1.png)

![image_is_ref_2.png](/images/image_is_ref_2.png)

![image_filtered_2.png](/images/image_filtered_2.png)

![image_is_ref_3.png](/images/image_is_ref_3.png)

![image_filtered_3.png](/images/image_filtered_3.png)

![image_is_ref_4.png](/images/image_is_ref_4.png)

![image_filtered_4.png](/images/image_filtered_4.png)
...
$$
 ...
 \int_{\Omega}p(m)dm = 1 \\ \int_{\Omega}D(m)(n \cdot m)dm = 1 \\ \int_{\phi=0}^{2\pi}\int_{\theta=0}^{\frac{\pi}{2}}D(\theta,\phi) cos \theta sin \theta d\theta d\phi = 1 \\
...
The term $ L*{DFG} $ is only dependent on $ n \cdot v $. Below, the normal is arbitrarily set to $ n=\left0, 0, 1\right $ and $v$ is chosen to satisfy $ n \cdot v $. The vector $ h_i $ is the $ D*{GGX}(\alpha) $ important direction sample $i$.
