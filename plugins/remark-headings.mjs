...
export const getFlattenedValue = (node) => node.children.map((child) => ("children" in child ? getFlattenedValue(child) : "value" in child ? child.value : "")).join("")
...
export function remarkHeadings({ exportName = "useTOC" }) {
    ...
    return (ast, file) => {
        ...
        visit(ast, ["heading", "mdxJsxFlowElement", "mdxjsEsm"], (node, _index, parent) => {
